						...
						<tbody>
							...
							if($res==TRUE){
								...
								<td>
									...
									<a href="<?php echo SITEURL;?>HallerAdmin/update-admin.php?id=<?php echo $id;?>" class="btn-sec">Edit</a>
									<a href="<?php echo SITEURL;?>HallerAdmin/delete-admin.php?id=<?php echo $id;?>" class="btn-delete"  onclick="return confirmDelete()">Delete</a>
                                </span></td>
							</tr>
										<?php
