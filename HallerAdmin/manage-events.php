						...
						<tbody>
							...
							if($res==TRUE){
								...
								<td>
									...
									<a href="<?php echo SITEURL;?>HallerAdmin/update-event.php?id=<?php echo $id;?>" class="btn-sec">Update event</a>
									<a href="<?php echo SITEURL;?>HallerAdmin/delete-event.php?id=<?php echo $id;?>" class="btn-delete" onclick="return confirmDelete()">Delete event</a>
                                </span></td>
							</tr>
										<?php
