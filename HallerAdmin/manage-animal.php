		...
		<main>
			<div class="head-title">
				<div class="left">
                    ...
                    <?php
                        if(isset($_SESSION['add_animal'])){ 
							echo $_SESSION['add_animal']; //Displaying Session Message
                        	unset($_SESSION['add_animal']); //Removing Session Message

						}
                        if(isset($_SESSION['delete_animal'])){ 
							echo $_SESSION['delete_animal']; //Displaying Session Message
                        	unset($_SESSION['delete_animal']); //Removing Session Message
                ...
                <div class="head">
						...
						<a href="add-animal.php " class="btn-primary">Add</a>
					</div>
						...
						<tbody>
							...
							if($res==TRUE){
								...
								<td>
									...
									<a href="<?php echo SITEURL;?>HallerAdmin/update-animal.php?id=<?php echo $id;?>" class="btn-sec">Edit</a>
									<a href="<?php echo SITEURL;?>HallerAdmin/delete-animal.php?id=<?php echo $id;?>" class="btn-delete" onclick="return confirmDelete()">Delete</a>
                                </span></td>
							</tr>
										<?php
